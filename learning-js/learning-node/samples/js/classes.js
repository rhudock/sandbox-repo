...
var Logger = function (_BaseLog) {
    ...
    function Logger(logName) {
        ...
        return _possibleConstructorReturn(this, (Logger.__proto__ || Object.getPrototypeOf(Logger)).call(this, logName));
    }

    _createClass(Logger, [{
        key: 'writeLine',
        value: function writeLine(msg) {
            _get(Logger.prototype.__proto__ || Object.getPrototypeOf(Logger.prototype), 'log', this).call(this, msg + '\r\n');
        }
    }]);
