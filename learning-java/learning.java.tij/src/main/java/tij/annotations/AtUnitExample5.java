...
import tij.net.mindview.atunit.TestObjectCleanup;
import tij.net.mindview.atunit.TestObjectCreate;
import tij.net.mindview.atunit.TestProperty;
...
public class AtUnitExample5 {
  ...
  public static void main(String[] args) throws Exception {
    OSExecute.command(
      "javatij.net.mindview.atunit.AtUnit AtUnitExample5");
  }
} /* Output:
