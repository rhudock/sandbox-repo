package tij.generics; //: generics/WatercolorSets.java
import static tij.generics.watercolors.Watercolors.BRILLIANT_RED;
import static tij.generics.watercolors.Watercolors.BURNT_UMBER;
import static tij.generics.watercolors.Watercolors.CERULEAN_BLUE_HUE;
import static tij.generics.watercolors.Watercolors.VIRIDIAN_HUE;
import static tij.net.mindview.util.Print.print;
import static tij.net.mindview.util.Sets.complement;
import static tij.net.mindview.util.Sets.difference;
import static tij.net.mindview.util.Sets.intersection;
import static tij.net.mindview.util.Sets.union;

import java.util.EnumSet;
import java.util.Set;

import tij.generics.watercolors.Watercolors;
