...
/**
 * REF: http://download.oracle.com/javase/tutorial/java/nutsandbolts/op3.html
 * 
 ...
 * section are less commonly used. Therefore, their coverage is brief; the
 * intent is to simply make you aware that these operators exist.
 * 
 ...
 * "0". For example, a byte contains 8 bits; applying this operator to a value
 ...
 * pattern is given by the left-hand operand, and the number of positions to
 ...
 * 
 * The following program, BitDemo, uses the bitwise AND operator to print the
...
public class BitDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(val ^ bitmask); // exclusive OR only one true  
		System.out.println(val | bitmask); // inclusive OR one or two true become true
	}
