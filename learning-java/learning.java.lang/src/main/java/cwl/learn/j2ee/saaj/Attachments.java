    ...
    public static void main(String[] args) {
        ...
        try {
            // One argument is passed in from build.xml
                    String xmlFile = null;
            if (args.length != 1) {
                xmlFile = "learningJava\\src\\com\\cwl\\j2ee\\saaj\\addr.txt";
                System.err.println("Usage: cmd filename, This time I will use " + xmlFile);
            } else {
                xmlFile = args[0];
            }
            ...
            fr = new FileReader(new File( xmlFile ));
