...
function loadCertificates() {
	_IsError = false;
	loadNuancePublicCertificates("./Certificates/Nuance/Public");
	loadNuancePrivateCertificate("./Certificates/Nuance/Private");  // May Comment out after Nuance testing.
	loadCBAPublicCertificates("./Certificates/CBA/Public");
}
